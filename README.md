...
- [CARTO Mobile SDK](https://github.com/CartoDB/mobile-sdk) - C++-based maps library with focust to offline features, for iOS, Android, Windows Phone and Xamarin with bindings for Java, ObjectiveC and C#. Based on Nutiteq SDK, but Open Source, uses CartoCSS to style MVT vector data.
